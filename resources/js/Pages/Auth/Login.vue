<template>
  <form @submit.prevent="login">
    <div class="w-1/2 mx-auto">
      ...
      <div class="mt-4">
        <button class="btn-primary w-full" type="submit">Loggin</button>
      </div>
      <div class="mt-4 text-center">
        <Link :href="route('user-account.create')" class="text-sm text-green-500 ">Need an account? Click here</Link>
      </div>
    </div>
  </form>
</template>
